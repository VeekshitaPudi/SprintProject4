    ...
    public class TicketController : Controller
    {
        ...
        public ActionResult Create(Ticket ticket)
        {
            ...
            try
            {
                ...
                string conStr = "DefaultEndpointsProtocol=https;AccountName=ticketcollectionproject;AccountKey=Mh/fmmNnYqJvjikdt5bZbzmrm6+mcWw+L1Ew7Sw9dnzr4LCz3uPylOh2FB540jzEZj45pIu9O1kXhZuZwCPnNg==;EndpointSuffix=core.windows.net";
